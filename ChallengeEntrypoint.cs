...
namespace DotnetChallenge
{
    public class HandleChallenge{
        ...
        void Challenge0() {
            Console.WriteLine("My very first challenge in the class as SD"); // TODO part 1 - Add a string of your choice, whatever you want
        }
        ...
        void Challenge5() {
            ...
            for (int i = 0; i < vulnerableUsers.Length; i++) 
            {
                Console.WriteLine(vulnerableUsers[i]);
            }
        }
    }
}